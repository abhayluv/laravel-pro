...
class ConfigurationsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'sidebar_link_background_color' => 'required|string',
            'sidebar_link_background_hover_color' => 'required|string',
            'sidebar_link_text_color' => 'required|string',
            'sidebar_link_text_hover_color' => 'required|string',
            'sidebar_active_link_background_color' => 'required|string',
            'sidebar_active_link_text_color' => 'required|string',
            'sidebar_active_link_border_top' => 'required|string',
            'sidebar_active_link_border_right' => 'required|string',
            'sidebar_active_link_border_bottom' => 'required|string',
            'sidebar_active_link_border_left' => 'required|string',
            'sidebar_link_padding' => 'required|string',
            'sidebar_link_margin' => 'required|string',
