    ...
    <div class="">
        <div class="mx-auto">
            <div class="bg-gray-50 dark:bg-gray-900 shadow-sm sm:rounded-lg border border-gray-200 rounded">
                ...
                <form method="POST" action="{{ route('master-forms.update', $masterForm) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="full_name" id="full_name" value="{{ old('full_name', $masterForm->full_name) }}" 
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $masterForm->email) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" 
                                   required>
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone_number" id="phone_number" value="{{ old('phone_number', $masterForm->phone_number) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" 
                                   required>
                            @error('phone_number')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap">
                                <label class="flex items-center">
                                    <input type="radio" name="gender" value="1" {{ old('gender', $masterForm->gender) == '1' ? 'checked' : '' }} 
                                ...
                                <label class="flex items-center ms-2">
                                    <input type="radio" name="gender" value="2" {{ old('gender', $masterForm->gender) == '2' ? 'checked' : '' }} 
                                           class="mr-2 text-indigo-600 focus:ring-indigo-500" required>
                                    <span class="text-sm text-gray-700">Female</span>
                                </label>
                                <label class="flex items-center ms-2">
                                    <input type="radio" name="gender" value="3" {{ old('gender', $masterForm->gender) == '3' ? 'checked' : '' }} 
                                           class="mr-2 text-indigo-600 focus:ring-indigo-500" required>
                        ...
                        <div>
                            ...
                            <select name="single_selection" id="single_selection" 
                                ...
                                <option value="1" {{ old('single_selection', $masterForm->single_selection) == '1' ? 'selected' : '' }}>Option 1</option>
                                <option value="2" {{ old('single_selection', $masterForm->single_selection) == '2' ? 'selected' : '' }}>Option 2</option>
                                <option value="3" {{ old('single_selection', $masterForm->single_selection) == '3' ? 'selected' : '' }}>Option 3</option>
                                <option value="4" {{ old('single_selection', $masterForm->single_selection) == '4' ? 'selected' : '' }}>Option 4</option>
                                <option value="5" {{ old('single_selection', $masterForm->single_selection) == '5' ? 'selected' : '' }}>Option 5</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="multi_selection[]" id="multi_selection" 
                                ...
                                <option value="">Select an option</option>
                                <option value="1" {{ in_array('1', old('multi_selection', $masterForm->multi_selection ?? [])) ? 'selected' : '' }}>Multi Option 1</option>
                                <option value="2" {{ in_array('2', old('multi_selection', $masterForm->multi_selection ?? [])) ? 'selected' : '' }}>Multi Option 2</option>
                                <option value="3" {{ in_array('3', old('multi_selection', $masterForm->multi_selection ?? [])) ? 'selected' : '' }}>Multi Option 3</option>
                                <option value="4" {{ in_array('4', old('multi_selection', $masterForm->multi_selection ?? [])) ? 'selected' : '' }}>Multi Option 4</option>
                                <option value="5" {{ in_array('5', old('multi_selection', $masterForm->multi_selection ?? [])) ? 'selected' : '' }}>Multi Option 5</option>
                            </select>
                        ...
                        <div>
                            ...
                            @if($masterForm->image_path)
                                <div class="mt-2 mb-2">
                                    <img src="{{ asset('storage/'.$masterForm->image_path) }}" class="h-32 w-32 object-cover rounded border" alt="Current image">
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap">
                                <label class="flex items-center">
                                    <input type="checkbox" name="languages[]" value="English" {{ in_array('English', old('languages', $masterForm->languages ?? [])) ? 'checked' : '' }} 
                                           class="mr-2 text-indigo-600 focus:ring-indigo-500">
                                    <span class="text-sm text-gray-700">English</span>
                                </label>
                                <label class="flex items-center ms-2">
                                    <input type="checkbox" name="languages[]" value="Hindi" {{ in_array('Hindi', old('languages', $masterForm->languages ?? [])) ? 'checked' : '' }} 
                                           class="mr-2 text-indigo-600 focus:ring-indigo-500">
                                    <span class="text-sm text-gray-700">Hindi</span>
                                </label>
                                <label class="flex items-center ms-2">
                                    <input type="checkbox" name="languages[]" value="Gujarati" {{ in_array('Gujarati', old('languages', $masterForm->languages ?? [])) ? 'checked' : '' }} 
                                           class="mr-2 text-indigo-600 focus:ring-indigo-500">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-md font-medium text-gray-700">Password (leave blank to keep current)</label>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_field" id="date_field" value="{{ old('date_field', $masterForm->date_field?->format('Y-m-d')) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            @error('date_field')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="time" name="time_field" id="time_field" value="{{ old('time_field', $masterForm->time_field?->format('H:i')) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                            @error('time_field')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="datetime_field" id="datetime_field" value="{{ old('datetime_field', $masterForm->datetime_field?->format('Y-m-d\TH:i')) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_range_start" id="date_range_start" value="{{ old('date_range_start', $masterForm->date_range_start?->format('Y-m-d')) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_range_end" id="date_range_end" value="{{ old('date_range_end', $masterForm->date_range_end?->format('Y-m-d')) }}" 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <!-- Range Slider -->
                        <div>
                            <label for="range_slider_value" class="block text-md font-medium text-gray-700">Range Slider: <span id="slider-value">{{ old('range_slider_value', $masterForm->range_slider_value) }}</span></label>
                            <input type="range" name="range_slider_value" id="range_slider_value" min="0" max="100" value="{{ old('range_slider_value', $masterForm->range_slider_value) }}" 
                        ...
                        <div>
                            ...
                            <input type="hidden" name="star_rating" id="star_rating_input" value="{{ old('star_rating', $masterForm->star_rating) }}">
                            @error('star_rating')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3" 
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('address', $masterForm->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="mt-1 border border-gray-300 rounded-md p-4">
                            @if($masterForm->signature)
                                <div class="mb-2">
                                    ...
                                    <img src="{{ $masterForm->signature }}" class="border border-gray-300 rounded" alt="Current signature">
                                </div>
                            @endif
                            <canvas id="signature-canvas" width="400" height="200" class="border border-gray-300 rounded cursor-crosshair"></canvas>
                            <input type="hidden" name="signature" id="signature_input" value="{{ $masterForm->signature }}">
                    ...
                    <div>
                        ...
                        <textarea name="text_editor" id="text_editor" rows="6" 
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('text_editor', $masterForm->text_editor) }}</textarea>
